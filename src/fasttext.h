...
class FastText {
 ...
 public:
  ...
  void getVectorNorm(Vector& vec, const std::string& word);
  void wordVectors(const std::string& word, std::string& res);
  void sentenceVectors(const std::string& sentence, std::string& res);
  void ngramVectors(std::string word, std::vector<std::string>& sub_vec);
  void ngramVectors(std::string word, std::string& res, std::string& sub);
  void ngramVectors(std::string word, std::vector<int>& is_word, std::vector<std::string>& sub);
  void ngramVectors_2(std::string word, std::vector<std::string>& sub);
  ...
  void getInputVector(Vector&, const std::string&) const;
  ...
  void skipgram(Model&, real, const std::vector<int32_t>&, const std::vector<int32_t>&);
